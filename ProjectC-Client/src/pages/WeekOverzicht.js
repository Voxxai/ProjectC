    ...
    return (
        <div className="flex h-full bg-slate-100">
            ...
            <div className='flex flex-col gap-y-2 p-4 pt-2 h-full w-full'>
                ...
                <div className="flex flex-row h-full gap-x-4 max-w-[1000px] overflow-x-auto snap-x">
                    
                    {/* Items */}
                    {dates.map((Date, index) => (
                        <div className="flex flex-col bg-white rounded-md text-gray-400 snap-start w-full min-w-[300px] p-2 shadow-md" key={index}>
